...
public class DrawingArbitraryShapes extends JApplet {
    ...
    public static void main(String s[]) {
        JFrame f = new JFrame("DrawingArbitraryShapes");
        f.addWindowListener(new WindowAdapter() {
            @Override
            public void windowClosing(WindowEvent e) {System.exit(0);}
        });
        JApplet applet = new DrawingArbitraryShapes();
